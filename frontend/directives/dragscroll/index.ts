...
const init = function (el, binding, vnode) {
  ...
  const reset = function () {
    ...
    target.md = function (e) {
      ...
      if (e.which === 2 && ignoreMiddle) {
        return;
      }
      if (e.which === 3 && ignoreRight) {
        return;
      }
      if (e.which === 4 && ignoreBack) {
        return;
      }
      if (e.which === 5 && ignoreForward) {
        return;
      }
    ...
    target.mm = function (e) {
      ...
      if (pushed) {
        ...
        const isEndX =
          target.scrollLeft + target.clientWidth >= target.scrollWidth || target.scrollLeft === 0;
        const isEndY =
          target.scrollTop + target.clientHeight >= target.scrollHeight || target.scrollTop === 0;
...
export const vueDragScroll = (app: App) => {
